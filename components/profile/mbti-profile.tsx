...
export function MbtiProfile({
	...
	const [mbtiData, setMbtiData] = useState({
		type: mbtiType || "INFJ",
		// nickname: "Advocate",
		introvertExtrovert: mbtiPercentages.introvertExtrovert || 65,
		sensingIntuition: mbtiPercentages.sensingIntuition || 78,
		thinkingFeeling: mbtiPercentages.thinkingFeeling || 82,
		judgingPerceiving: mbtiPercentages.judgingPerceiving || 60,
		chronotype: chronotype || "Night Owl",
		productiveHours: productiveHours || ["evening", "night"],
		sleepTime: sleepTime || "23:30",
		wakeTime: wakeTime || "07:30",
	});
							...
							<div className="space-y-4">
								<div className="space-y-2">
									...
									<div className="relative">
										<Progress
											value={mbtiData.introvertExtrovert}
											className="h-2"
										/>
										<div
								...
								<div className="space-y-2">
									...
									<div className="relative">
										<Progress
											value={mbtiData.sensingIntuition}
											className="h-2"
										/>
										<div
											className="absolute top-0 h-4 w-1 bg-primary -mt-1 rounded-full"
									...
									<div className="text-right text-sm text-muted-foreground">
										{mbtiData.sensingIntuition}% Intuitive
									</div>
								</div>
								...
								<div className="space-y-2">
									...
									<div className="relative">
										<Progress
											value={mbtiData.thinkingFeeling}
											className="h-2"
										/>
										<div
											className="absolute top-0 h-4 w-1 bg-primary -mt-1 rounded-full"
									...
									<div className="text-right text-sm text-muted-foreground">
										{mbtiData.thinkingFeeling}% Feeling
									</div>
								</div>
								...
								<div className="space-y-2">
									...
									<div className="relative">
										<Progress
											value={mbtiData.judgingPerceiving}
											className="h-2"
										/>
										<div
											className="absolute top-0 h-4 w-1 bg-primary -mt-1 rounded-full"
									...
									<div className="text-right text-sm text-muted-foreground">
										{mbtiData.judgingPerceiving}% Judging
									</div>
								</div>
							</div>
						</CardContent>
						...
						<div className="flex flex-wrap gap-2">
							{["morning", "afternoon", "evening", "night"].map((time) => (
								<Badge
									key={time}
									variant={
										mbtiData.productiveHours.includes(time)
											? "default"
											: "outline"
									}
