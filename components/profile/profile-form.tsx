...
export function ProfileForm({ user }: any) {
	...
	const form = useForm<z.infer<typeof formSchema>>({
      ...
      interests: userr?.interests,
			// name: userr?.name || "Alex Johnson",
			// email: userr?.email || "alex@example.com",
			// age: userr?.ageRange || "25-34",
			// gender: userr?.gender || "male",
			// occupation: userr?.occupation || "UX Designer",
			// interests: userr?.interests || "Reading, hiking, photography, cooking",
		},
	});
				...
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							...
							<FormDescription>
								This helps us understand your daily commitments
							</FormDescription>
							<FormMessage />
						</FormItem>
					)}
				...
				<FormField
					...
					render={({ field }) => (
						<FormItem>
							...
							<FormDescription>
								We'll incorporate your interests into your routine
							</FormDescription>
							<FormMessage />
						</FormItem>
					)}
