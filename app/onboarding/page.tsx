	...
	const handleComplete = async() => {
		...
		const data = {
			...
			mbtiPercentages: {
				...
				sensingIntuition: formData.mbti.sensingIntuition,
				thinkingFeeling: formData.mbti.thinkingFeeling,
									...
									<div className="text-center space-y-6">
										...
										<div className="space-y-2">
											...
											<p className="text-muted-foreground">
												Let's set up your profile to create personalized
												routines that work for you. This will only take a few
												minutes.
											</p>
										</div>
							...
							<Card className="bg-card/80 backdrop-blur-sm">
								<CardContent className="pt-6">
									<div className="space-y-6">
										...
										<UserProfileForm
											onSubmit={(data) => handleFormSubmit("profile", data)}
										/>
									</div>
								</CardContent>
							</Card>
								...
								<CardContent className="pt-6">
									<div className="space-y-6">
										<div>
											...
											<p className="text-muted-foreground">
												Your MBTI type helps us understand how you prefer to
												work and relax
											</p>
										</div>
										<MbtiForm
											onSubmit={(data) => handleFormSubmit("mbti", data)}
										/>
									</div>
								</CardContent>
							</Card>
								...
								<CardContent className="pt-6">
									<div className="space-y-6">
										<div>
											...
											<p className="text-muted-foreground">
												Understanding your natural energy patterns helps us
												schedule tasks at optimal times
											</p>
										</div>
										<ChronotypeForm
											onSubmit={(data) => handleFormSubmit("chronotype", data)}
										/>
									</div>
								</CardContent>
							</Card>
								...
								<CardContent className="pt-6">
									<div className="space-y-6">
										<div>
											...
											<p className="text-muted-foreground">
												Define what you want to achieve so we can help you get
												there
											</p>
										</div>
										<GoalForm
											onSubmit={(data) => handleFormSubmit("goals", data)}
										/>
									</div>
								</CardContent>
							</Card>
								...
								<CardContent className="pt-6 pb-8 px-8">
									<div className="text-center space-y-6">
										...
										<div className="space-y-2">
											...
											<p className="text-muted-foreground">
												Your profile is complete. We're ready to generate your
